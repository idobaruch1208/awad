        ...
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-md px-6">
                ...
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-bold gradient-text">AWAD Content Engine</h1>
                    <p className="text-gray-400 mt-2 text-sm">Internal AI Publishing Portal</p>
                </div>
                ...
                <div className="glass rounded-2xl p-8">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-white font-medium transition-all duration-200 mb-5 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {googleLoading ? (
                            <>
                    ...
                    {/* Email/Password form — uses Server Action so session is set server-side */}
